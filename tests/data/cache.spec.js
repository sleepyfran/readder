...
/* -- TESTS -- */
test('set should add the element to the cache when it does not exist', () => {
...
test('set should modify an element of the cache if the key is present', () => {
...
test('has should return if the element is present or not', () => {
    const testElement = addRandomObject()
...
test('get should return the element if the key is present', () => {
    const testElement = addRandomObject()
...
test('get should return undefined if the key has expired', () => {
...
test('get should return undefined if the key is not present', () => {
    expect(cache.get('non-existent')).toBeUndefined()
})

test('remove should remove the element if they key is present', () => {
    const testElement = addRandomObject()
